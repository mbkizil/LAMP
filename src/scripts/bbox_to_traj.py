...
def format_traj_line(traj):
    """Formats trajectory data for file output. Each frame contains tx, ty, tz values separated by spaces, frames separated by '|'."""
    frame_strs = []
    for f in traj:
        frame_vals = [f["tx"], f["ty"], f["tz"]]
...
if __name__ == "__main__":
    ...
    random.seed(99)
    print(tags_file_path, output_file_path)
